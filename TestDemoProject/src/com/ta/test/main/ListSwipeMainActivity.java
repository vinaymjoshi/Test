...
import com.ta.test.listswipe.SwipeDismissListViewTouchListener;
import com.ta.test.listswipe.SwipeDismissTouchListener;

public class ListSwipeMainActivity extends ListActivity {
        ...
        for (int i = 0; i < items.length; i++) {
            ...
            dismissableButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(ListSwipeMainActivity.this,
